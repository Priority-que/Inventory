...
public class UserServiceImpl implements UserService {
    ...
    public IPage<UserVO> getUserPage(UserQuery userQuery) {
        ...
        IPage<UserVO> page = userMapper.getUserPage(userPage, userQuery);
        return page;
    }
    ...
    public Result addUser(UserDTO userDTO) {
        ...
        User userName = userMapper.getUserDetailByUserName(username);
        if (userName != null) {
    ...
    public Result updateUserStatus(UserStatusDTO userStatusDTO) {
        ...
        userStatus.setId(userStatusDTO.getId());
        userStatus.setStatus(userStatusDTO.getStatus());
        if (userMapper.updateById(userStatus) > 0) {
    ...
    public Result updateUserRole(UserRoleDTO userRoleDTO) {
        ...
        Long userRoleId = userRoleDTO.getUserId();
        userRoleMapper.deleteByUserId(userRoleId);
        UserRole userRole = new UserRole();
